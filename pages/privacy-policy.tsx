export default function privacyPolicy() {
  return (
    <>
      ...
      <p>Effective date: 21st day of February, 2023</p>
      <p>
        {"{REPLACE URL}"} (the &quot;Site&quot;) is owned and operated
        by Magnus Klein Ltd. Magnus Klein Ltd is the data controller and can be
        contacted at:
      </p>
      <p>magnusklein@gmail.com</p>
      <p>81 The Murrays, Edinburgh, EH17 8UD</p>
      <h2>Purpose</h2>
      <p>
      ...
      <p>You can withdraw your consent by: Contacting magnusklein@gmail.com.</p>
      ...
      <ol>
        <li>User&apos;s interactions while using site.</li>
      </ol>
      <p>
      ...
      <p>
        ...
        16 years of age, the personal data will be deleted as soon as possible.
        If a child under 16 years of age has provided us with personal data
        their parent or guardian may contact our data protection officer.
      </p>
      ...
      <p>
        ...
        any of your other rights under the GDPR, please contact our data
      ...
      <p>
        ...
        on the content you access, how long you stay on our Site, etc;
      </p>
      <h3>Targeting cookies</h3>
      <p>
        Targeting cookies collect data on how you use the Site and your
        preferences. This allows us to personalise the information you see on
        our Site for you; and
      </p>
      ...
      <ol>
        <li>Monitor how users interact with this website; and</li>
        <li>
      ...
      <p>
        ...
        data protection officer, John Robertson, at:
      </p>
      <p>magnusklein@gmail.com</p>
    </>
  );
